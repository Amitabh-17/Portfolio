...
import { ArrowDown, Database, LineChart, BrainCircuit } from 'lucide-react'
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        >
          ...
          <ParallaxSection speed={0.3}>
            ...
            >
              Data Science & Analytics student turning large, messy datasets into predictive models and dashboards people can actually use
            </motion.p>
          </ParallaxSection>
